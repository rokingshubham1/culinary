...
**
*/
!function(o,c,d){var l=[],e={_version:"3.7.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,t){var n=this;setTimeout(function(){t(n[e])},0)},addTest:function(e,t,n){l.push({name:e,fn:t,options:n})},addAsyncTest:function(e){l.push({name:null,fn:e})}},a=function(){};a.prototype=e,a=new a;var u=[];function m(e,t){return typeof e===t}var v=c.documentElement,h="svg"===v.nodeName.toLowerCase();function y(){return"function"!=typeof c.createElement?c.createElement(arguments[0]):h?c.createElementNS.call(c,"http://www.w3.org/2000/svg",arguments[0]):c.createElement.apply(c,arguments)}a.addTest("svg",!!c.createElementNS&&!!c.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect);var r=y("input"),t="autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),s={};a.input=function(e){for(var t=0,n=e.length;t<n;t++)s[e[t]]=!!(e[t]in r);return s.list&&(s.list=!(!y("datalist")||!o.HTMLDataListElement)),s}(t);var n="Moz O ms Webkit",f=e._config.usePrefixes?n.split(" "):[];e._cssomPrefixes=f;var i={elem:y("modernizr")};a._q.push(function(){delete i.elem});var g={style:i.elem.style};function p(e,t,n,r){var s,o,i,l,a,u="modernizr",f=y("div"),p=((a=c.body)||((a=y(h?"svg":"body")).fake=!0),a);if(parseInt(n,10))for(;n--;)(i=y("div")).id=r?r[n]:u+(n+1),f.appendChild(i);return(s=y("style")).type="text/css",s.id="s"+u,(p.fake?p:f).appendChild(s),p.appendChild(f),s.styleSheet?s.styleSheet.cssText=e:s.appendChild(c.createTextNode(e)),f.id=u,p.fake&&(p.style.background="",p.style.overflow="hidden",l=v.style.overflow,v.style.overflow="hidden",v.appendChild(p)),o=t(f,e),p.fake?(p.parentNode.removeChild(p),v.style.overflow=l,v.offsetHeight):f.parentNode.removeChild(f),!!o}function C(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function w(e,t){var n=e.length;if("CSS"in o&&"supports"in o.CSS){for(;n--;)if(o.CSS.supports(C(e[n]),t))return!0;return!1}if("CSSSupportsRule"in o){for(var r=[];n--;)r.push("("+C(e[n])+":"+t+")");return p("@supports ("+(r=r.join(" or "))+") { #modernizr { position: absolute; } }",function(e){return"absolute"===function(e,t,n){var r;if("getComputedStyle"in o){r=getComputedStyle.call(o,e,t);var s=o.console;null!==r?n&&(r=r.getPropertyValue(n)):s&&s[s.error?"error":"log"].call(s,"getComputedStyle returning null, its possible modernizr test results are inaccurate")}else r=!t&&e.currentStyle&&e.currentStyle[n];return r}(e,null,"position")})}return d}a._q.unshift(function(){delete g.style});var S=e._config.usePrefixes?n.toLowerCase().split(" "):[];function x(e,t){return function(){return e.apply(t,arguments)}}function b(e,t,n,r,s){var o=e.charAt(0).toUpperCase()+e.slice(1),i=(e+" "+f.join(o+" ")+o).split(" ");return m(t,"string")||m(t,"undefined")?function(e,t,n,r){if(r=!m(r,"undefined")&&r,!m(n,"undefined")){var s=w(e,n);if(!m(s,"undefined"))return s}for(var o,i,l,a,u,f=["modernizr","tspan","samp"];!g.style&&f.length;)o=!0,g.modElem=y(f.shift()),g.style=g.modElem.style;function p(){o&&(delete g.style,delete g.modElem)}for(l=e.length,i=0;i<l;i++)if(a=e[i],u=g.style[a],~(""+a).indexOf("-")&&(a=a.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")),g.style[a]!==d){if(r||m(n,"undefined"))return p(),"pfx"!==t||a;try{g.style[a]=n}catch(e){}if(g.style[a]!==u)return p(),"pfx"!==t||a}return p(),!1}(i,t,r,s):function(e,t,n){var r;for(var s in e)if(e[s]in t)return!1===n?e[s]:m(r=t[e[s]],"function")?x(r,n||t):r;return!1}(i=(e+" "+S.join(o+" ")+o).split(" "),t,n)}function _(e,t,n){return b(e,d,d,t,n)}e._domPrefixes=S,e.testAllProps=b,e.testAllProps=_,a.addTest("flexbox",_("flexBasis","1px",!0)),function(){var e,t,n,r,s,o;for(var i in l)if(l.hasOwnProperty(i)){if(e=[],(t=l[i]).name&&(e.push(t.name.toLowerCase()),t.options&&t.options.aliases&&t.options.aliases.length))for(n=0;n<t.options.aliases.length;n++)e.push(t.options.aliases[n].toLowerCase());for(r=m(t.fn,"function")?t.fn():t.fn,s=0;s<e.length;s++)1===(o=e[s].split(".")).length?a[o[0]]=r:(!a[o[0]]||a[o[0]]instanceof Boolean||(a[o[0]]=new Boolean(a[o[0]])),a[o[0]][o[1]]=r),u.push((r?"":"no-")+o.join("-"))}}(),function(e){var t=v.className,n=a._config.classPrefix||"";if(h&&(t=t.baseVal),a._config.enableJSClass){var r=new RegExp("(^|\\s)"+n+"no-js(\\s|$)");t=t.replace(r,"$1"+n+"js$2")}a._config.enableClasses&&(0<e.length&&(t+=" "+n+e.join(" "+n)),h?v.className.baseVal=t:v.className=t)}(u),delete e.addTest,delete e.addAsyncTest;for(var E=0;E<a._q.length;E++)a._q[E]();o.Modernizr=a}(window,document);
...
var objectFitImages=function(){"use strict";var o="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==",c=/(object-fit|object-position)\s*:\s*([^;$"'\s]+)/g,a="object-fit"in document.createElement("i").style,u=!1;function s(e,t){var n,i,r=function(t){for(var e,n=getComputedStyle(t).fontFamily,i={};null!==(e=c.exec(n));)i[e[1]]=e[2];return i}(e);r["object-fit"]&&"fill"!==r["object-fit"]&&(t=t||e.currentSrc||e.src,e.srcset&&(e.srcset=""),e[o]||(e.src=o,n=e,i={get:function(){return n[o].s},set:function(t){return delete n[o].i,s(n,t)}},Object.defineProperty(n,"src",i),Object.defineProperty(n,"currentSrc",{get:i.get})),e[o]=e[o]||{s:t},e.style.backgroundImage="url("+t+")",e.style.backgroundPosition=r["object-position"]||"center",e.style.backgroundRepeat="no-repeat",r["object-fit"].indexOf("scale-down")<0?e.style.backgroundSize=r["object-fit"].replace("none","auto"):(e[o].i||(e[o].i=new Image,e[o].i.src=t),function t(){e[o].i.naturalWidth?e[o].i.naturalWidth>e.width||e[o].i.naturalHeight>e.height?e.style.backgroundSize="contain":e.style.backgroundSize="auto":setTimeout(t,100)}()))}function l(t){"IMG"===t.target.tagName&&s(t.target)}function A(t,e){if(a)return!1;var n,i=!u&&!t;e=e||{},"string"==typeof(t=t||"img")?t=document.querySelectorAll("img"):t.length||(t=[t]);for(var r=0;r<t.length;r++)s(t[r]);i&&(document.body.addEventListener("load",l,!0),u=!0,t="img"),e.watchMQ&&(n=t,window.addEventListener("resize",A.bind(null,n)))}return A}();
!function(t,d){var u,n=t.jQuery||t.Cowboy||(t.Cowboy={});n.throttle=u=function(e,i,r,a){var c,f=0;function t(){var t=this,n=+new Date-f,o=arguments;function u(){f=+new Date,r.apply(t,o)}a&&!c&&u(),c&&clearTimeout(c),a===d&&e<n?u():!0!==i&&(c=setTimeout(a?function(){c=d}:u,a===d?e-n:e))}return"boolean"!=typeof i&&(a=r,r=i,i=d),n.guid&&(t.guid=r.guid=r.guid||n.guid++),t},n.debounce=function(t,n,o){return o===d?u(t,n,!1):u(t,o,!1!==n)}}(this);
!function(e){var a=0,t=!1,o=!1;try{var n=Object.defineProperty({},"passive",{get:function(){o=!0}});window.addEventListener("test",null,n)}catch(e){}var r=function(e){for(var t=e.target;t!==document.body&&t!==document;){var o=window.getComputedStyle(t);if(!o)break;if("INPUT"===t.nodeName&&"range"===t.getAttribute("type"))return;var n=o.getPropertyValue("-webkit-overflow-scrolling"),r=o.getPropertyValue("overflow-y"),i=parseInt(o.getPropertyValue("height"),10),u="touch"===n&&("auto"===r||"scroll"===r),c=t.scrollHeight>t.offsetHeight;if(u&&c){var d=e.touches?e.touches[0].screenY:e.screenY,l=a<=d&&0===t.scrollTop,s=d<=a&&t.scrollHeight-t.scrollTop===i;return void((l||s)&&e.preventDefault())}t=t.parentNode}e.preventDefault()},i=function(e){a=e.touches?e.touches[0].screenY:e.screenY},u=function(){window.addEventListener("touchstart",i,!!o&&{passive:!1}),window.addEventListener("touchmove",r,!!o&&{passive:!1}),t=!0},c=document.createElement("div");document.documentElement.appendChild(c),c.style.WebkitOverflowScrolling="touch";var d="getComputedStyle"in window&&"touch"===window.getComputedStyle(c)["-webkit-overflow-scrolling"];document.documentElement.removeChild(c),d&&u();var l={enable:u,disable:function(){window.removeEventListener("touchstart",i,!1),window.removeEventListener("touchmove",r,!1),t=!1},isEnabled:function(){return t}};"undefined"!=typeof module&&module.exports&&(module.exports=l),"function"==typeof e.define?(0,e.define)("iNoBounce",[],function(){return l}):e.iNoBounce=l}(this);
...
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";_gsScope._gsDefine("easing.CustomEase",["easing.Ease"],function(m){var x=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,S=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,_=/[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,d=/[cLlsS]/g,v="CustomEase only accepts Cubic Bezier data.",D=function(e,t,i,n,s,o,a,r,h,u,c){var l,f=(e+i)/2,g=(t+n)/2,p=(i+s)/2,x=(n+o)/2,d=(s+a)/2,y=(o+r)/2,m=(f+p)/2,S=(g+x)/2,_=(p+d)/2,v=(x+y)/2,w=(m+_)/2,M=(S+v)/2,b=a-e,k=r-t,C=Math.abs((i-a)*k-(n-r)*b),z=Math.abs((s-a)*k-(o-r)*b);return u||(u=[{x:e,y:t},{x:a,y:r}],c=1),u.splice(c||u.length-1,0,{x:w,y:M}),h*(b*b+k*k)<(C+z)*(C+z)&&(l=u.length,D(e,t,f,g,m,S,w,M,h,u,c),D(w,M,_,v,d,y,a,r,h,u,c+1+(u.length-l))),u},n=function(e){var t=this.lookup[e*this.l|0]||this.lookup[this.l-1];return t.nx<e&&(t=t.n),t.y+(e-t.x)/t.cx*t.cy},s=function(e,t,i){this._calcEnd=!0,(this.id=e)&&(m.map[e]=this),this.getRatio=n,this.setData(t,i)},e=s.prototype=new m;return e.constructor=s,e.setData=function(e,t){var i,n,s,o,a,r,h,u,c,l,f=(e=e||"0,0,1,1").match(x),g=1,p=[];if(l=(t=t||{}).precision||1,this.data=e,this.lookup=[],this.points=p,this.fast=l<=1,(d.test(e)||-1!==e.indexOf("M")&&-1===e.indexOf("C"))&&(f=function(e){var t,i,n,s,o,a,r,h,u,c,l,f=(e+"").replace(_,function(e){var t=+e;return t<1e-4&&-1e-4<t?0:t}).match(S)||[],g=[],p=0,x=0,d=f.length,y=2;for(t=0;t<d;t++)if(u=s,isNaN(f[t])?o=(s=f[t].toUpperCase())!==f[t]:t--,i=+f[t+1],n=+f[t+2],o&&(i+=p,n+=x),t||(r=i,h=n),"M"===s)a&&a.length<8&&(g.length-=1,y=0),p=r=i,x=h=n,a=[i,n],y=2,g.push(a),t+=2,s="L";else if("C"===s)a||(a=[0,0]),a[y++]=i,a[y++]=n,o||(p=x=0),a[y++]=p+1*f[t+3],a[y++]=x+1*f[t+4],a[y++]=p+=1*f[t+5],a[y++]=x+=1*f[t+6],t+=6;else if("S"===s)"C"===u||"S"===u?(c=p-a[y-4],l=x-a[y-3],a[y++]=p+c,a[y++]=x+l):(a[y++]=p,a[y++]=x),a[y++]=i,a[y++]=n,o||(p=x=0),a[y++]=p+=1*f[t+3],a[y++]=x+=1*f[t+4],t+=4;else{if("L"!==s&&"Z"!==s)throw v;"Z"===s&&(i=r,n=h,a.closed=!0),("L"===s||.5<Math.abs(p-i)||.5<Math.abs(x-n))&&(a[y++]=p+(i-p)/3,a[y++]=x+(n-x)/3,a[y++]=p+2*(i-p)/3,a[y++]=x+2*(n-x)/3,a[y++]=i,a[y++]=n,"L"===s&&(t+=2)),p=i,x=n}return g[0]}(e)),4===(i=f.length))f.unshift(0,0),f.push(1,1),i=8;else if((i-2)%6)throw v;for(0==+f[0]&&1==+f[i-2]||function(e,t,i){i||0===i||(i=Math.max(+e[e.length-1],+e[1]));var n,s=-1*+e[0],o=-i,a=e.length,r=1/(+e[a-2]+s),h=-t||(Math.abs(+e[a-1]-+e[1])<.01*(+e[a-2]-+e[0])?function(e){var t,i=e.length,n=999999999999;for(t=1;t<i;t+=6)+e[t]<n&&(n=+e[t]);return n}(e)+o:+e[a-1]+o);for(h=h?1/h:-r,n=0;n<a;n+=2)e[n]=(+e[n]+s)*r,e[n+1]=(+e[n+1]+o)*h}(f,t.height,t.originY),this.rawBezier=f,o=2;o<i;o+=6)n={x:+f[o-2],y:+f[o-1]},s={x:+f[o+4],y:+f[o+5]},p.push(n,s),D(n.x,n.y,+f[o],+f[o+1],+f[o+2],+f[o+3],s.x,s.y,1/(2e5*l),p,p.length-1);for(i=p.length,o=0;o<i;o++)h=p[o],u=p[o-1]||h,h.x>u.x||u.y!==h.y&&u.x===h.x||h===u?(u.cx=h.x-u.x,u.cy=h.y-u.y,u.n=h,u.nx=h.x,this.fast&&1<o&&2<Math.abs(u.cy/u.cx-p[o-2].cy/p[o-2].cx)&&(this.fast=!1),u.cx<g&&(u.cx?g=u.cx:(u.cx=.001,o===i-1&&(u.x-=.001,g=Math.min(g,.001),this.fast=!1)))):(p.splice(o--,1),i--);if(i=1/g+1|0,a=1/(this.l=i),h=p[r=0],this.fast){for(o=0;o<i;o++)c=o*a,h.nx<c&&(h=p[++r]),n=h.y+(c-h.x)/h.cx*h.cy,this.lookup[o]={x:c,cx:a,y:n,cy:0,nx:9},o&&(this.lookup[o-1].cy=n-this.lookup[o-1].y);this.lookup[i-1].cy=p[p.length-1].y-n}else{for(o=0;o<i;o++)h.nx<o*a&&(h=p[++r]),this.lookup[o]=h;r<p.length-1&&(this.lookup[o-1]=p[p.length-2])}return this._calcEnd=1!==p[p.length-1].y||0!==p[0].y,this},e.getRatio=n,e.getSVGData=function(e){return s.getSVGData(this,e)},s.create=function(e,t,i){return new s(e,t,i)},s.version="0.2.2",s.bezierToPoints=D,s.get=function(e){return m.map[e]},s.getSVGData=function(e,t){var i,n,s,o,a,r,h,u,c,l,f=1e3,g=(t=t||{}).width||100,p=t.height||100,x=t.x||0,d=(t.y||0)+p,y=t.path;if(t.invert&&(p=-p,d=0),(e=e.getRatio?e:m.map[e]||console.log("No ease found: ",e)).rawBezier){for(i=[],h=e.rawBezier.length,s=0;s<h;s+=2)i.push(((x+e.rawBezier[s]*g)*f|0)/f+","+((d+e.rawBezier[s+1]*-p)*f|0)/f);i[0]="M"+i[0],i[1]="C"+i[1]}else for(i=["M"+x+","+d],o=1/(h=Math.max(5,200*(t.precision||1))),u=5/(h+=2),c=((x+o*g)*f|0)/f,n=((l=((d+e.getRatio(o)*-p)*f|0)/f)-d)/(c-x),s=2;s<h;s++)a=((x+s*o*g)*f|0)/f,r=((d+e.getRatio(s*o)*-p)*f|0)/f,(Math.abs((r-l)/(a-c)-n)>u||s===h-1)&&(i.push(c+","+l),n=(r-l)/(a-c)),c=a,l=r;return y&&("string"==typeof y?document.querySelector(y):y).setAttribute("d",i.join(" ")),i.join(" ")},s},!0)}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(e){"use strict";var t=function(){return(_gsScope.GreenSockGlobals||_gsScope).CustomEase};"undefined"!=typeof module&&module.exports?(require("../TweenLite.js"),module.exports=t()):"function"==typeof define&&define.amd&&define(["TweenLite"],t)}();